...
urlpatterns = [
    ...
    path('profile/assets/delete/', views.delete_professional_asset, name='delete_professional_asset'),
    path('profile/assets/<str:image_type>/<int:image_id>/delete/', views.delete_professional_asset, name='delete_professional_asset_param'),
    ...
    path('hardware/shops/<int:shop_id>/images/<int:image_id>/delete/', views.delete_hardware_shop_image, name='delete_hardware_shop_image_param'),
    path('hardware/shops/<int:shop_id>/banner/delete/', views.delete_hardware_shop_image, {'image_type': 'banner'}, name='delete_hardware_shop_banner'),
    path('hardware/shops/images/delete/', views.delete_hardware_shop_image, name='delete_hardware_shop_image'),
